...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "AUDAX Technology — Distributeur officiel des produits VAR en Algérie" },
      { name: "description", content: "AUDAX Technology distribue en Algérie la gamme VAR : moniteurs VAR N22 / T24M, PC de bureau VAR XPS22F / XPS22M et accessoires. Prix DZD, livraison 69 wilayas, paiement à la livraison." },
      { property: "og:title", content: "AUDAX Technology — Produits VAR en Algérie" },
      { property: "og:description", content: "AUDAX Technology, distributeur officiel VAR en Algérie : moniteurs, PC All-In-One et accessoires informatiques. Livraison 69 wilayas." },
...
function Index() {
  return (
    <div className="dark relative bg-background text-foreground">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "Organization", name: "AUDAX Technology", alternateName: ["AUDAX", "AUDAX DZ", "Distributeur VAR Algérie"], url: "https://audax-dz.tech/", logo: "https://audax-dz.tech/favicon-var.png", brand: { "@type": "Brand", name: "VAR" }, areaServed: { "@type": "Country", name: "Algeria" }, contactPoint: [{ "@type": "ContactPoint", telephone: "+213770741873", contactType: "customer service", areaServed: "DZ", availableLanguage: ["French", "Arabic"] }], sameAs: ["https://audax-dz.tech/", "https://wa.me/213770741873"] }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "Store", "@id": "https://audax-dz.tech/#store", name: "AUDAX Technology — Boutique informatique", image: "https://audax-dz.tech/favicon-var.png", telephone: "+213770741873", priceRange: "DZD", url: "https://audax-dz.tech/", address: { "@type": "PostalAddress", addressCountry: "DZ", addressRegion: "Alger" }, areaServed: { "@type": "Country", name: "Algeria" }, makesOffer: [{ "@type": "Offer", itemOffered: { "@type": "Product", name: "Moniteur VAR N22", brand: "VAR", category: "Moniteur informatique" } }, { "@type": "Offer", itemOffered: { "@type": "Product", name: "Moniteur VAR T24M", brand: "VAR", category: "Moniteur informatique" } }, { "@type": "Offer", itemOffered: { "@type": "Product", name: "PC All-In-One VAR XPS22F", brand: "VAR", category: "Ordinateur de bureau" } }, { "@type": "Offer", itemOffered: { "@type": "Product", name: "PC All-In-One VAR XPS22M", brand: "VAR", category: "Ordinateur de bureau" } }] }) }} />
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "WebSite", name: "AUDAX Technology", alternateName: "AUDAX DZ", url: "https://audax-dz.tech/", potentialAction: { "@type": "SearchAction", target: "https://audax-dz.tech/commander?q={search_term_string}", "query-input": "required name=search_term_string" } }) }} />
