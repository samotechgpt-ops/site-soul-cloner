...
function Index() {
  return (
    <div className="dark relative bg-background text-foreground">
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "Organization", name: "VAR Algérie", alternateName: ["VAR DZ", "AUDAX Technology", "Distributeur VAR Algérie"], url: "https://audax-dz.tech/", logo: "https://audax-dz.tech/favicon-var.png", brand: { "@type": "Brand", name: "VAR" }, areaServed: { "@type": "Country", name: "Algeria" }, contactPoint: [{ "@type": "ContactPoint", telephone: "+213770741873", contactType: "customer service", areaServed: "DZ", availableLanguage: ["French", "Arabic"] }], sameAs: ["https://audax-dz.tech/", "https://wa.me/213770741873"] }) }} />
