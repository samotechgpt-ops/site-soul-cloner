...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "AUDAX Gaming" },
      { property: "og:title", content: "AUDAX Gaming Algérie — Moniteurs et PC All-In-One" },
      { property: "og:description", content: "AUDAX Gaming Algérie : moniteurs, PC All-In-One, matériel gaming et bureautique avec commande rapide et catalogue produit." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@AudaxGaming" },
      { name: "twitter:title", content: "AUDAX Gaming Algérie — Moniteurs et PC All-In-One" },
      { name: "twitter:description", content: "AUDAX Gaming Algérie : moniteurs, PC All-In-One, matériel gaming et bureautique avec commande rapide et catalogue produit." },
