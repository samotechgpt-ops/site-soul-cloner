...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "VAR Algérie — Moniteurs VAR, PC VAR & Ordinateurs | audax-dz.tech" },
      { property: "og:description", content: "Achetez la marque VAR en Algérie : moniteurs VAR N22 / T24M, PC de bureau VAR XPS22F / XPS22M et accessoires informatiques VAR. Prix DZD, livraison 69 wilayas, paiement à la livraison." },
